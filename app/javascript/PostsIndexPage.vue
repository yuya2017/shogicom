              ...
              <div class="profile_main mx-2">
                ...
                <div class="card profile_link" v-bind:id="'profile' + post.id">
                  <div class="card-body profile_body">
                    ...
                    <a v-if="user.id!=post.user.id" class="card-link profile_btn" rel="nofollow" data-method="post" :href="'/rooms/create_private_room?user_id='+post.user.id">個人用チャットルーム</a>
                  </div>
                </div>
              </div>
